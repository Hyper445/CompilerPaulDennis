...
TRAVsons(node * arg_node, info * arg_info)
{
	...
	case N_program:
		...
		TRAV(PROGRAM_CONSTANTTABLE(arg_node), arg_info);
		TRAV(PROGRAM_EXPORTTABLE(arg_node), arg_info);
		TRAV(PROGRAM_EXTERNTABLE(arg_node), arg_info);
		break;
	case N_decls:
	...
	case N_var:
		...
		break;
	case N_constant:
		TRAV(CONSTANT_NEXT(arg_node), arg_info);
		break;
	case N_export:
		TRAV(EXPORT_NEXT(arg_node), arg_info);
		break;
	case N_extern:
		TRAV(EXTERN_NEXT(arg_node), arg_info);
		break;
	case N_symboltable:
...
TRAVgetSon(int no, node * parent)
{
	...
	case N_program:
		...
		case 1:
			...
			break;
		case 2:
			result = PROGRAM_CONSTANTTABLE(parent);
			break;
		case 3:
			result = PROGRAM_EXPORTTABLE(parent);
			break;
		case 4:
			result = PROGRAM_EXTERNTABLE(parent);
			break;
		default:
