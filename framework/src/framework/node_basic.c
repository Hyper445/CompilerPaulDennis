...
node           *TBmakeProgram(node * Decls, node * Symboltable, node * Constanttable, node * Exporttable, node * Externtable) {
	node           *this;
	...
	DBUG_PRINT("MAKE", ("assigning son Constanttable initial value: %s ", Constanttable));
	PROGRAM_CONSTANTTABLE(this) = Constanttable;
	DBUG_PRINT("MAKE", ("assigning son Exporttable initial value: %s ", Exporttable));
	PROGRAM_EXPORTTABLE(this) = Exporttable;
	DBUG_PRINT("MAKE", ("assigning son Externtable initial value: %s ", Externtable));
	PROGRAM_EXTERNTABLE(this) = Externtable;
#ifndef DBUG_OFF
	...
	if ((PROGRAM_CONSTANTTABLE(this) != NULL) && (NODE_TYPE(PROGRAM_CONSTANTTABLE(this)) != N_constant)) {
		CTIwarn("Field Constanttable of node N_Program has non-allowed target node.");
	}
	if ((PROGRAM_EXPORTTABLE(this) != NULL) && (NODE_TYPE(PROGRAM_EXPORTTABLE(this)) != N_export)) {
		CTIwarn("Field Exporttable of node N_Program has non-allowed target node.");
	}
	if ((PROGRAM_EXTERNTABLE(this) != NULL) && (NODE_TYPE(PROGRAM_EXTERNTABLE(this)) != N_extern)) {
		CTIwarn("Field Externtable of node N_Program has non-allowed target node.");
	}
#endif				/* DBUG_OFF */
	DBUG_RETURN(this);
}
...
#ifndef DBUG_OFF
	DBUG_PRINT("MAKE", ("doing son target checks"));
	if ((DECLS_DECL(this) != NULL) && (NODE_TYPE(DECLS_DECL(this)) != N_fundef) && (NODE_TYPE(DECLS_DECL(this)) != N_globdecl) && (NODE_TYPE(DECLS_DECL(this)) != N_globdef)) {
...
node           *TBmakeExprs(node * Expr, node * Next) {
	node           *this;
...
#ifndef DBUG_OFF
	DBUG_PRINT("MAKE", ("doing son target checks"));
	if ((EXPRS_EXPR(this) != NULL) && (NODE_TYPE(EXPRS_EXPR(this)) != N_condexpr) && (NODE_TYPE(EXPRS_EXPR(this)) != N_binop) && (NODE_TYPE(EXPRS_EXPR(this)) != N_monop) && (NODE_TYPE(EXPRS_EXPR(this)) != N_funcall) && (NODE_TYPE(EXPRS_EXPR(this)) != N_cast) && (NODE_TYPE(EXPRS_EXPR(this)) != N_var) && (NODE_TYPE(EXPRS_EXPR(this)) != N_num) && (NODE_TYPE(EXPRS_EXPR(this)) != N_float) && (NODE_TYPE(EXPRS_EXPR(this)) != N_bool) && (NODE_TYPE(EXPRS_EXPR(this)) != N_arrexpr)) {
		CTIwarn("Field Expr of node N_Exprs has non-allowed target node.");
	}
	if ((EXPRS_NEXT(this) != NULL) && (NODE_TYPE(EXPRS_NEXT(this)) != N_exprs)) {
...
#ifndef DBUG_OFF
	DBUG_PRINT("MAKE", ("doing son target checks"));
	if ((ARREXPR_EXPRS(this) != NULL) && (NODE_TYPE(ARREXPR_EXPRS(this)) != N_exprs)) {
...
node           *TBmakeIds(char *Name, node * Next){
	node           *this;
...
#ifndef DBUG_OFF
	DBUG_PRINT("MAKE", ("doing son target checks"));
	if ((EXPRSTMT_EXPR(this) != NULL) && (NODE_TYPE(EXPRSTMT_EXPR(this)) != N_condexpr) && (NODE_TYPE(EXPRSTMT_EXPR(this)) != N_binop) && (NODE_TYPE(EXPRSTMT_EXPR(this)) != N_monop) && (NODE_TYPE(EXPRSTMT_EXPR(this)) != N_funcall) && (NODE_TYPE(EXPRSTMT_EXPR(this)) != N_cast) && (NODE_TYPE(EXPRSTMT_EXPR(this)) != N_var) && (NODE_TYPE(EXPRSTMT_EXPR(this)) != N_num) && (NODE_TYPE(EXPRSTMT_EXPR(this)) != N_float) && (NODE_TYPE(EXPRSTMT_EXPR(this)) != N_bool) && (NODE_TYPE(EXPRSTMT_EXPR(this)) != N_arrexpr)) {
...
node           *TBmakeReturn(node * Expr) {
	...
	RETURN_TYPE(this) = T_unknown;
#ifndef DBUG_OFF
	DBUG_PRINT("MAKE", ("doing son target checks"));
	if ((RETURN_EXPR(this) != NULL) && (NODE_TYPE(RETURN_EXPR(this)) != N_condexpr) && (NODE_TYPE(RETURN_EXPR(this)) != N_binop) && (NODE_TYPE(RETURN_EXPR(this)) != N_monop) && (NODE_TYPE(RETURN_EXPR(this)) != N_funcall) && (NODE_TYPE(RETURN_EXPR(this)) != N_cast) && (NODE_TYPE(RETURN_EXPR(this)) != N_var) && (NODE_TYPE(RETURN_EXPR(this)) != N_num) && (NODE_TYPE(RETURN_EXPR(this)) != N_float) && (NODE_TYPE(RETURN_EXPR(this)) != N_bool) && (NODE_TYPE(RETURN_EXPR(this)) != N_arrexpr)) {
...
node           *TBmakeFuncall(char *Name, node * Decl, node * Args){
	node           *this;
	...
	FUNCALL_FUNDEF(this) = NULL;
#ifndef DBUG_OFF
	DBUG_PRINT("MAKE", ("doing son target checks"));
	if ((FUNCALL_ARGS(this) != NULL) && (NODE_TYPE(FUNCALL_ARGS(this)) != N_exprs)) {
...
node           *TBmakeCast(type Type_left, node * Expr) {
	node           *this;
	...
	DBUG_PRINT("MAKE", ("assigning son Expr initial value: %s ", Expr));
	CAST_EXPR(this) = Expr;
	CAST_TYPE_LEFT(this) = Type_left;
	CAST_TYPE_RIGHT(this) = T_unknown;
#ifndef DBUG_OFF
	DBUG_PRINT("MAKE", ("doing son target checks"));
	if ((CAST_EXPR(this) != NULL) && (NODE_TYPE(CAST_EXPR(this)) != N_condexpr) && (NODE_TYPE(CAST_EXPR(this)) != N_binop) && (NODE_TYPE(CAST_EXPR(this)) != N_monop) && (NODE_TYPE(CAST_EXPR(this)) != N_funcall) && (NODE_TYPE(CAST_EXPR(this)) != N_cast) && (NODE_TYPE(CAST_EXPR(this)) != N_var) && (NODE_TYPE(CAST_EXPR(this)) != N_num) && (NODE_TYPE(CAST_EXPR(this)) != N_float) && (NODE_TYPE(CAST_EXPR(this)) != N_bool) && (NODE_TYPE(CAST_EXPR(this)) != N_arrexpr)) {
...
node           *TBmakeFundef(type Type, char *Name, node * Params, node * FunBody, node * Symboltable){
	node           *this;
	...
	if ((FUNDEF_SYMBOLTABLE(this) != NULL) && (NODE_TYPE(FUNDEF_SYMBOLTABLE(this)) != N_symboltable)) {
		CTIwarn("Field Symboltable of node N_FunDef has non-allowed target node.");
	}
#endif				/* DBUG_OFF */
	DBUG_RETURN(this);
}
...
#ifndef DBUG_OFF
	DBUG_PRINT("MAKE", ("doing son target checks"));
	if ((IFELSE_COND(this) != NULL) && (NODE_TYPE(IFELSE_COND(this)) != N_condexpr) && (NODE_TYPE(IFELSE_COND(this)) != N_binop) && (NODE_TYPE(IFELSE_COND(this)) != N_monop) && (NODE_TYPE(IFELSE_COND(this)) != N_funcall) && (NODE_TYPE(IFELSE_COND(this)) != N_cast) && (NODE_TYPE(IFELSE_COND(this)) != N_var) && (NODE_TYPE(IFELSE_COND(this)) != N_num) && (NODE_TYPE(IFELSE_COND(this)) != N_float) && (NODE_TYPE(IFELSE_COND(this)) != N_bool) && (NODE_TYPE(IFELSE_COND(this)) != N_arrexpr)) {
...
#ifndef DBUG_OFF
	DBUG_PRINT("MAKE", ("doing son target checks"));
	if ((WHILE_COND(this) != NULL) && (NODE_TYPE(WHILE_COND(this)) != N_condexpr) && (NODE_TYPE(WHILE_COND(this)) != N_binop) && (NODE_TYPE(WHILE_COND(this)) != N_monop) && (NODE_TYPE(WHILE_COND(this)) != N_funcall) && (NODE_TYPE(WHILE_COND(this)) != N_cast) && (NODE_TYPE(WHILE_COND(this)) != N_var) && (NODE_TYPE(WHILE_COND(this)) != N_num) && (NODE_TYPE(WHILE_COND(this)) != N_float) && (NODE_TYPE(WHILE_COND(this)) != N_bool) && (NODE_TYPE(WHILE_COND(this)) != N_arrexpr)) {
...
#ifndef DBUG_OFF
	DBUG_PRINT("MAKE", ("doing son target checks"));
	if ((DOWHILE_COND(this) != NULL) && (NODE_TYPE(DOWHILE_COND(this)) != N_condexpr) && (NODE_TYPE(DOWHILE_COND(this)) != N_binop) && (NODE_TYPE(DOWHILE_COND(this)) != N_monop) && (NODE_TYPE(DOWHILE_COND(this)) != N_funcall) && (NODE_TYPE(DOWHILE_COND(this)) != N_cast) && (NODE_TYPE(DOWHILE_COND(this)) != N_var) && (NODE_TYPE(DOWHILE_COND(this)) != N_num) && (NODE_TYPE(DOWHILE_COND(this)) != N_float) && (NODE_TYPE(DOWHILE_COND(this)) != N_bool) && (NODE_TYPE(DOWHILE_COND(this)) != N_arrexpr)) {
...
#ifndef DBUG_OFF
	DBUG_PRINT("MAKE", ("doing son target checks"));
	if ((FOR_START(this) != NULL) && (NODE_TYPE(FOR_START(this)) != N_condexpr) && (NODE_TYPE(FOR_START(this)) != N_binop) && (NODE_TYPE(FOR_START(this)) != N_monop) && (NODE_TYPE(FOR_START(this)) != N_funcall) && (NODE_TYPE(FOR_START(this)) != N_cast) && (NODE_TYPE(FOR_START(this)) != N_var) && (NODE_TYPE(FOR_START(this)) != N_num) && (NODE_TYPE(FOR_START(this)) != N_float) && (NODE_TYPE(FOR_START(this)) != N_bool) && (NODE_TYPE(FOR_START(this)) != N_arrexpr)) {
		CTIwarn("Field Start of node N_For has non-allowed target node.");
	}
	if ((FOR_STOP(this) != NULL) && (NODE_TYPE(FOR_STOP(this)) != N_condexpr) && (NODE_TYPE(FOR_STOP(this)) != N_binop) && (NODE_TYPE(FOR_STOP(this)) != N_monop) && (NODE_TYPE(FOR_STOP(this)) != N_funcall) && (NODE_TYPE(FOR_STOP(this)) != N_cast) && (NODE_TYPE(FOR_STOP(this)) != N_var) && (NODE_TYPE(FOR_STOP(this)) != N_num) && (NODE_TYPE(FOR_STOP(this)) != N_float) && (NODE_TYPE(FOR_STOP(this)) != N_bool) && (NODE_TYPE(FOR_STOP(this)) != N_arrexpr)) {
		CTIwarn("Field Stop of node N_For has non-allowed target node.");
	}
	if ((FOR_STEP(this) != NULL) && (NODE_TYPE(FOR_STEP(this)) != N_condexpr) && (NODE_TYPE(FOR_STEP(this)) != N_binop) && (NODE_TYPE(FOR_STEP(this)) != N_monop) && (NODE_TYPE(FOR_STEP(this)) != N_funcall) && (NODE_TYPE(FOR_STEP(this)) != N_cast) && (NODE_TYPE(FOR_STEP(this)) != N_var) && (NODE_TYPE(FOR_STEP(this)) != N_num) && (NODE_TYPE(FOR_STEP(this)) != N_float) && (NODE_TYPE(FOR_STEP(this)) != N_bool) && (NODE_TYPE(FOR_STEP(this)) != N_arrexpr)) {
...
node           *TBmakeCondexpr(node * Pred, node * Then, node * Else) {
	node           *this;
...
#ifndef DBUG_OFF
	DBUG_PRINT("MAKE", ("doing son target checks"));
	if ((CONDEXPR_PRED(this) != NULL) && (NODE_TYPE(CONDEXPR_PRED(this)) != N_condexpr) && (NODE_TYPE(CONDEXPR_PRED(this)) != N_binop) && (NODE_TYPE(CONDEXPR_PRED(this)) != N_monop) && (NODE_TYPE(CONDEXPR_PRED(this)) != N_funcall) && (NODE_TYPE(CONDEXPR_PRED(this)) != N_cast) && (NODE_TYPE(CONDEXPR_PRED(this)) != N_var) && (NODE_TYPE(CONDEXPR_PRED(this)) != N_num) && (NODE_TYPE(CONDEXPR_PRED(this)) != N_float) && (NODE_TYPE(CONDEXPR_PRED(this)) != N_bool) && (NODE_TYPE(CONDEXPR_PRED(this)) != N_arrexpr)) {
		CTIwarn("Field Pred of node N_CondExpr has non-allowed target node.");
	}
	if ((CONDEXPR_THEN(this) != NULL) && (NODE_TYPE(CONDEXPR_THEN(this)) != N_condexpr) && (NODE_TYPE(CONDEXPR_THEN(this)) != N_binop) && (NODE_TYPE(CONDEXPR_THEN(this)) != N_monop) && (NODE_TYPE(CONDEXPR_THEN(this)) != N_funcall) && (NODE_TYPE(CONDEXPR_THEN(this)) != N_cast) && (NODE_TYPE(CONDEXPR_THEN(this)) != N_var) && (NODE_TYPE(CONDEXPR_THEN(this)) != N_num) && (NODE_TYPE(CONDEXPR_THEN(this)) != N_float) && (NODE_TYPE(CONDEXPR_THEN(this)) != N_bool) && (NODE_TYPE(CONDEXPR_THEN(this)) != N_arrexpr)) {
		CTIwarn("Field Then of node N_CondExpr has non-allowed target node.");
	}
	if ((CONDEXPR_ELSE(this) != NULL) && (NODE_TYPE(CONDEXPR_ELSE(this)) != N_condexpr) && (NODE_TYPE(CONDEXPR_ELSE(this)) != N_binop) && (NODE_TYPE(CONDEXPR_ELSE(this)) != N_monop) && (NODE_TYPE(CONDEXPR_ELSE(this)) != N_funcall) && (NODE_TYPE(CONDEXPR_ELSE(this)) != N_cast) && (NODE_TYPE(CONDEXPR_ELSE(this)) != N_var) && (NODE_TYPE(CONDEXPR_ELSE(this)) != N_num) && (NODE_TYPE(CONDEXPR_ELSE(this)) != N_float) && (NODE_TYPE(CONDEXPR_ELSE(this)) != N_bool) && (NODE_TYPE(CONDEXPR_ELSE(this)) != N_arrexpr)) {
...
node           *TBmakeGlobdecl(type Type, char *Name, node * Decl, node * Dims){
	node           *this;
	...
	GLOBDECL_DECL(this) = Decl;
#ifndef DBUG_OFF
	DBUG_PRINT("MAKE", ("doing son target checks"));
	if ((GLOBDECL_DIMS(this) != NULL) && (NODE_TYPE(GLOBDECL_DIMS(this)) != N_ids)) {
...
node           *TBmakeGlobdef(type Type, char *Name, node * Decl, node * Dims, node * Init){
	node           *this;
	...
	if ((GLOBDEF_INIT(this) != NULL) && (NODE_TYPE(GLOBDEF_INIT(this)) != N_condexpr) && (NODE_TYPE(GLOBDEF_INIT(this)) != N_binop) && (NODE_TYPE(GLOBDEF_INIT(this)) != N_monop) && (NODE_TYPE(GLOBDEF_INIT(this)) != N_funcall) && (NODE_TYPE(GLOBDEF_INIT(this)) != N_cast) && (NODE_TYPE(GLOBDEF_INIT(this)) != N_var) && (NODE_TYPE(GLOBDEF_INIT(this)) != N_num) && (NODE_TYPE(GLOBDEF_INIT(this)) != N_float) && (NODE_TYPE(GLOBDEF_INIT(this)) != N_bool) && (NODE_TYPE(GLOBDEF_INIT(this)) != N_arrexpr)) {
...
node           *TBmakeParam(type Type, char *Name, node * Dims, node * Next){
	node           *this;
...
node           *TBmakeVardecl(type Type, char *Name, node * Decl, node * Dims, node * Init, node * Next){
	node           *this;
	...
	VARDECL_DECL(this) = Decl;
#ifndef DBUG_OFF
	DBUG_PRINT("MAKE", ("doing son target checks"));
	if ((VARDECL_DIMS(this) != NULL) && (NODE_TYPE(VARDECL_DIMS(this)) != N_exprs)) {
		CTIwarn("Field Dims of node N_VarDecl has non-allowed target node.");
	}
	if ((VARDECL_INIT(this) != NULL) && (NODE_TYPE(VARDECL_INIT(this)) != N_condexpr) && (NODE_TYPE(VARDECL_INIT(this)) != N_binop) && (NODE_TYPE(VARDECL_INIT(this)) != N_monop) && (NODE_TYPE(VARDECL_INIT(this)) != N_funcall) && (NODE_TYPE(VARDECL_INIT(this)) != N_cast) && (NODE_TYPE(VARDECL_INIT(this)) != N_var) && (NODE_TYPE(VARDECL_INIT(this)) != N_num) && (NODE_TYPE(VARDECL_INIT(this)) != N_float) && (NODE_TYPE(VARDECL_INIT(this)) != N_bool) && (NODE_TYPE(VARDECL_INIT(this)) != N_arrexpr)) {
		CTIwarn("Field Init of node N_VarDecl has non-allowed target node.");
	}
	if ((VARDECL_NEXT(this) != NULL) && (NODE_TYPE(VARDECL_NEXT(this)) != N_vardecl)) {
...
node           *TBmakeAssign(node * Let, node * Expr) {
	...
	ASSIGN_TYPE(this) = T_unknown;
#ifndef DBUG_OFF
	DBUG_PRINT("MAKE", ("doing son target checks"));
	if ((ASSIGN_LET(this) != NULL) && (NODE_TYPE(ASSIGN_LET(this)) != N_varlet)) {
		CTIwarn("Field Let of node N_Assign has non-allowed target node.");
	}
	if ((ASSIGN_EXPR(this) != NULL) && (NODE_TYPE(ASSIGN_EXPR(this)) != N_condexpr) && (NODE_TYPE(ASSIGN_EXPR(this)) != N_binop) && (NODE_TYPE(ASSIGN_EXPR(this)) != N_monop) && (NODE_TYPE(ASSIGN_EXPR(this)) != N_funcall) && (NODE_TYPE(ASSIGN_EXPR(this)) != N_cast) && (NODE_TYPE(ASSIGN_EXPR(this)) != N_var) && (NODE_TYPE(ASSIGN_EXPR(this)) != N_num) && (NODE_TYPE(ASSIGN_EXPR(this)) != N_float) && (NODE_TYPE(ASSIGN_EXPR(this)) != N_bool) && (NODE_TYPE(ASSIGN_EXPR(this)) != N_arrexpr)) {
...
node           *TBmakeBinop(binop Op, node * Left, node * Right) {
	...
	BINOP_OP(this) = Op;
	BINOP_TYPE(this) = T_unknown;
	BINOP_SUBTYPE(this) = T_unknown;
#ifndef DBUG_OFF
	DBUG_PRINT("MAKE", ("doing son target checks"));
	if ((BINOP_LEFT(this) != NULL) && (NODE_TYPE(BINOP_LEFT(this)) != N_condexpr) && (NODE_TYPE(BINOP_LEFT(this)) != N_binop) && (NODE_TYPE(BINOP_LEFT(this)) != N_monop) && (NODE_TYPE(BINOP_LEFT(this)) != N_funcall) && (NODE_TYPE(BINOP_LEFT(this)) != N_cast) && (NODE_TYPE(BINOP_LEFT(this)) != N_var) && (NODE_TYPE(BINOP_LEFT(this)) != N_num) && (NODE_TYPE(BINOP_LEFT(this)) != N_float) && (NODE_TYPE(BINOP_LEFT(this)) != N_bool) && (NODE_TYPE(BINOP_LEFT(this)) != N_arrexpr)) {
		CTIwarn("Field Left of node N_BinOp has non-allowed target node.");
	}
	if ((BINOP_RIGHT(this) != NULL) && (NODE_TYPE(BINOP_RIGHT(this)) != N_condexpr) && (NODE_TYPE(BINOP_RIGHT(this)) != N_binop) && (NODE_TYPE(BINOP_RIGHT(this)) != N_monop) && (NODE_TYPE(BINOP_RIGHT(this)) != N_funcall) && (NODE_TYPE(BINOP_RIGHT(this)) != N_cast) && (NODE_TYPE(BINOP_RIGHT(this)) != N_var) && (NODE_TYPE(BINOP_RIGHT(this)) != N_num) && (NODE_TYPE(BINOP_RIGHT(this)) != N_float) && (NODE_TYPE(BINOP_RIGHT(this)) != N_bool) && (NODE_TYPE(BINOP_RIGHT(this)) != N_arrexpr)) {
...
node           *TBmakeMonop(monop Op, node * Operand) {
	...
	MONOP_OP(this) = Op;
	MONOP_TYPE(this) = T_unknown;
#ifndef DBUG_OFF
	DBUG_PRINT("MAKE", ("doing son target checks"));
	if ((MONOP_OPERAND(this) != NULL) && (NODE_TYPE(MONOP_OPERAND(this)) != N_condexpr) && (NODE_TYPE(MONOP_OPERAND(this)) != N_binop) && (NODE_TYPE(MONOP_OPERAND(this)) != N_monop) && (NODE_TYPE(MONOP_OPERAND(this)) != N_funcall) && (NODE_TYPE(MONOP_OPERAND(this)) != N_cast) && (NODE_TYPE(MONOP_OPERAND(this)) != N_var) && (NODE_TYPE(MONOP_OPERAND(this)) != N_num) && (NODE_TYPE(MONOP_OPERAND(this)) != N_float) && (NODE_TYPE(MONOP_OPERAND(this)) != N_bool) && (NODE_TYPE(MONOP_OPERAND(this)) != N_arrexpr)) {
...
node           *TBmakeVarlet(char *Name, node * Decl, node * Indices){
	node           *this;
...
#ifndef DBUG_OFF
	DBUG_PRINT("MAKE", ("doing son target checks"));
	if ((VARLET_INDICES(this) != NULL) && (NODE_TYPE(VARLET_INDICES(this)) != N_exprs)) {
...
node           *TBmakeVar(char *Name, node * Decl, node * Indices){
	node           *this;
...
#ifndef DBUG_OFF
	DBUG_PRINT("MAKE", ("doing son target checks"));
	if ((VAR_INDICES(this) != NULL) && (NODE_TYPE(VAR_INDICES(this)) != N_exprs)) {
...
node           *TBmakeConstant(type Type, node * Value, int Index, node * Next){
	node           *this;
	DBUG_ENTER("TBmakeConstant");
	DBUG_PRINT("MAKE", ("allocating node structure"));
	this = MakeEmptyNode();
	NODE_TYPE(this) = N_constant;
	DBUG_PRINT("MAKE", ("address: %s ", this));
	DBUG_PRINT("MAKE", ("allocating sons structure"));
	this->sons.N_constant = MEMmalloc(sizeof(struct SONS_N_CONSTANT));
	DBUG_PRINT("MAKE", ("allocating attrib structure"));
	this->attribs.N_constant = MEMmalloc(sizeof(struct ATTRIBS_N_CONSTANT));
	DBUG_PRINT("MAKE", ("setting node type"));
	NODE_TYPE(this) = N_constant;
	DBUG_PRINT("MAKE", ("assigning son Next initial value: %s ", Next));
	CONSTANT_NEXT(this) = Next;
	CONSTANT_TYPE(this) = Type;
	CONSTANT_VALUE(this) = Value;
	CONSTANT_INDEX(this) = Index;
#ifndef DBUG_OFF
	DBUG_PRINT("MAKE", ("doing son target checks"));
	if ((CONSTANT_NEXT(this) != NULL) && (NODE_TYPE(CONSTANT_NEXT(this)) != N_constant)) {
		CTIwarn("Field Next of node N_Constant has non-allowed target node.");
	}
#endif				/* DBUG_OFF */
	DBUG_RETURN(this);
}
...
node           *TBmakeExport(int IndexLevel, node * Fundef, node * Next){
	node           *this;
	...
	NODE_TYPE(this) = N_export;
	DBUG_PRINT("MAKE", ("assigning son Next initial value: %s ", Next));
	EXPORT_NEXT(this) = Next;
	EXPORT_INDEXLEVEL(this) = IndexLevel;
	EXPORT_FUNDEF(this) = Fundef;
#ifndef DBUG_OFF
	DBUG_PRINT("MAKE", ("doing son target checks"));
	if ((EXPORT_NEXT(this) != NULL) && (NODE_TYPE(EXPORT_NEXT(this)) != N_export)) {
		CTIwarn("Field Next of node N_Export has non-allowed target node.");
	}
#endif				/* DBUG_OFF */
	DBUG_RETURN(this);
}
...
node           *TBmakeExtern(int IndexLevel, node * Fundef, node * Next){
	node           *this;
	...
	NODE_TYPE(this) = N_extern;
	DBUG_PRINT("MAKE", ("assigning son Next initial value: %s ", Next));
	EXTERN_NEXT(this) = Next;
	EXTERN_INDEXLEVEL(this) = IndexLevel;
	EXTERN_FUNDEF(this) = Fundef;
#ifndef DBUG_OFF
	DBUG_PRINT("MAKE", ("doing son target checks"));
	if ((EXTERN_NEXT(this) != NULL) && (NODE_TYPE(EXTERN_NEXT(this)) != N_extern)) {
		CTIwarn("Field Next of node N_Extern has non-allowed target node.");
	}
#endif				/* DBUG_OFF */
	DBUG_RETURN(this);
}
...
node           *TBmakeSymboltable(char *Name, node * Parent, node * Params, node * Entries){
	node           *this;
	...
	SYMBOLTABLE_PARAMS(this) = Params;
#ifndef DBUG_OFF
	DBUG_PRINT("MAKE", ("doing son target checks"));
...
node           *TBmakeSymboltableentry(char *Name, type Type, int NestingLevel, int IndexLevel, node * Params, node * Fundef, bool isFunction, node * Next){
	node           *this;
	...
	SYMBOLTABLEENTRY_INDEXLEVEL(this) = IndexLevel;
	SYMBOLTABLEENTRY_PARAMS(this) = Params;
	SYMBOLTABLEENTRY_FUNDEF(this) = Fundef;
