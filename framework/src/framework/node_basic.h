...
#define PROGRAM_CONSTANTTABLE( n) ((n)->sons.N_program->Constanttable)
#define PROGRAM_EXPORTTABLE( n) ((n)->sons.N_program->Exporttable)
#define PROGRAM_EXTERNTABLE( n) ((n)->sons.N_program->Externtable)
extern node    *TBmakeProgram(node * Decls, node * Symboltable, node * Constanttable, node * Exporttable, node * Externtable);
...
#define RETURN_TYPE( n) ((n)->attribs.N_return->Type)
...
#define FUNCALL_FUNDEF( n) ((n)->attribs.N_funcall->Fundef)
...
#define CAST_TYPE_LEFT( n) ((n)->attribs.N_cast->Type_left)
#define CAST_TYPE_RIGHT( n) ((n)->attribs.N_cast->Type_right)
extern node    *TBmakeCast(type Type_left, node * Expr);
...
extern node    *TBmakeFundef(type Type, char *Name, node * Params, node * FunBody, node * Symboltable);
...
#define GLOBDECL_DECL( n) ((n)->attribs.N_globdecl->Decl)
extern node    *TBmakeGlobdecl(type Type, char *Name, node * Decl, node * Dims);
...
#define GLOBDEF_DECL( n) ((n)->attribs.N_globdef->Decl)
#define GLOBDEF_FLAGSTRUCTURE( n) ((n)->attribs.N_globdef->flags)
#define GLOBDEF_ISEXPORT( n) ((n)->attribs.N_globdef->flags.IsExport)
extern node    *TBmakeGlobdef(type Type, char *Name, node * Decl, node * Dims, node * Init);
...
#define VARDECL_DECL( n) ((n)->attribs.N_vardecl->Decl)
extern node    *TBmakeVardecl(type Type, char *Name, node * Decl, node * Dims, node * Init, node * Next);
...
#define ASSIGN_TYPE( n) ((n)->attribs.N_assign->Type)
...
#define BINOP_TYPE( n) ((n)->attribs.N_binop->Type)
#define BINOP_SUBTYPE( n) ((n)->attribs.N_binop->SubType)
...
#define MONOP_TYPE( n) ((n)->attribs.N_monop->Type)
...
/*****************************************************************************
 * macros and functions for N_constant
 *****************************************************************************/

#define CONSTANT_NEXT( n) ((n)->sons.N_constant->Next)
#define CONSTANT_TYPE( n) ((n)->attribs.N_constant->Type)
#define CONSTANT_VALUE( n) ((n)->attribs.N_constant->Value)
#define CONSTANT_INDEX( n) ((n)->attribs.N_constant->Index)
extern node    *TBmakeConstant(type Type, node * Value, int Index, node * Next);

/*****************************************************************************
 * macros and functions for N_export
 *****************************************************************************/

#define EXPORT_NEXT( n) ((n)->sons.N_export->Next)
#define EXPORT_INDEXLEVEL( n) ((n)->attribs.N_export->IndexLevel)
#define EXPORT_FUNDEF( n) ((n)->attribs.N_export->Fundef)
extern node    *TBmakeExport(int IndexLevel, node * Fundef, node * Next);

/*****************************************************************************
 * macros and functions for N_extern
 *****************************************************************************/

#define EXTERN_NEXT( n) ((n)->sons.N_extern->Next)
#define EXTERN_INDEXLEVEL( n) ((n)->attribs.N_extern->IndexLevel)
#define EXTERN_FUNDEF( n) ((n)->attribs.N_extern->Fundef)
extern node    *TBmakeExtern(int IndexLevel, node * Fundef, node * Next);
...
#define SYMBOLTABLE_PARAMS( n) ((n)->attribs.N_symboltable->Params)
extern node    *TBmakeSymboltable(char *Name, node * Parent, node * Params, node * Entries);
...
#define SYMBOLTABLEENTRY_INDEXLEVEL( n) ((n)->attribs.N_symboltableentry->IndexLevel)
#define SYMBOLTABLEENTRY_PARAMS( n) ((n)->attribs.N_symboltableentry->Params)
#define SYMBOLTABLEENTRY_FUNDEF( n) ((n)->attribs.N_symboltableentry->Fundef)
#define SYMBOLTABLEENTRY_ISFUNCTION( n) ((n)->attribs.N_symboltableentry->isFunction)
extern node    *TBmakeSymboltableentry(char *Name, type Type, int NestingLevel, int IndexLevel, node * Params, node * Fundef, bool isFunction, node * Next);
