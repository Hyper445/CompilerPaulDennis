...
extern node    *TBmakeVardecl(type Type, char *Name, node * Dims, node * Init, node * Next);
...
extern node    *TBmakeSymboltable(char *Name, node * Entries);
...
extern node    *TBmakeSymboltableentry(char *Name, type Type, int NestingLevel, node * Next);
