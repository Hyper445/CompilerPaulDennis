...
node           *COPYassign(node * arg_node, info * arg_info) {
	...
	LUTinsertIntoLutP(INFO_LUT(arg_info), arg_node, result);
	/* Copy attributes */
	ASSIGN_TYPE(result) = ASSIGN_TYPE(arg_node);
	/* Copy sons */
...
node           *COPYbinop(node * arg_node, info * arg_info) {
	...
	BINOP_TYPE(result) = BINOP_TYPE(arg_node);
	BINOP_SUBTYPE(result) = BINOP_SUBTYPE(arg_node);
	/* Copy sons */
...
node           *COPYcast(node * arg_node, info * arg_info) {
	...
	LUTinsertIntoLutP(INFO_LUT(arg_info), arg_node, result);
	/* Copy attributes */
	CAST_TYPE_LEFT(result) = CAST_TYPE_LEFT(arg_node);
	CAST_TYPE_RIGHT(result) = CAST_TYPE_RIGHT(arg_node);
	/* Copy sons */
 ...
 *
 ***************************************************************************/
node           *COPYcondexpr(node * arg_node, info * arg_info) {
 ...
 *
 ***************************************************************************/
node           *COPYconstant(node * arg_node, info * arg_info) {
	node           *result = TBmakeConstant(T_unknown, NULL, 0, NULL);
	DBUG_ENTER("COPYconstant");
	LUTinsertIntoLutP(INFO_LUT(arg_info), arg_node, result);
	/* Copy attributes */
	CONSTANT_TYPE(result) = CONSTANT_TYPE(arg_node);
	CONSTANT_VALUE(result) = LUTsearchInLutPp(INFO_LUT(arg_info), CONSTANT_VALUE(arg_node));
	CONSTANT_INDEX(result) = CONSTANT_INDEX(arg_node);
	/* Copy sons */
	CONSTANT_NEXT(result) = COPYTRAV(CONSTANT_NEXT(arg_node), arg_info);
	/* Return value */
	DBUG_RETURN(result);
}
/** <!--******************************************************************-->
 ...
 *
 ***************************************************************************/
node           *COPYexport(node * arg_node, info * arg_info) {
	node           *result = TBmakeExport(0, NULL, NULL);
	DBUG_ENTER("COPYexport");
	LUTinsertIntoLutP(INFO_LUT(arg_info), arg_node, result);
	/* Copy attributes */
	EXPORT_INDEXLEVEL(result) = EXPORT_INDEXLEVEL(arg_node);
	EXPORT_FUNDEF(result) = LUTsearchInLutPp(INFO_LUT(arg_info), EXPORT_FUNDEF(arg_node));
	/* Copy sons */
	EXPORT_NEXT(result) = COPYTRAV(EXPORT_NEXT(arg_node), arg_info);
	/* Return value */
	DBUG_RETURN(result);
}
/** <!--******************************************************************-->
 ...
 *
 ***************************************************************************/
node           *COPYexprs(node * arg_node, info * arg_info) {
 ...
 *
 ***************************************************************************/
node           *COPYextern(node * arg_node, info * arg_info) {
	node           *result = TBmakeExtern(0, NULL, NULL);
	DBUG_ENTER("COPYextern");
	LUTinsertIntoLutP(INFO_LUT(arg_info), arg_node, result);
	/* Copy attributes */
	EXTERN_INDEXLEVEL(result) = EXTERN_INDEXLEVEL(arg_node);
	EXTERN_FUNDEF(result) = LUTsearchInLutPp(INFO_LUT(arg_info), EXTERN_FUNDEF(arg_node));
	/* Copy sons */
	EXTERN_NEXT(result) = COPYTRAV(EXTERN_NEXT(arg_node), arg_info);
	/* Return value */
	DBUG_RETURN(result);
}
/** <!--******************************************************************-->
 ...
 *
 ***************************************************************************/
node           *COPYfuncall(node * arg_node, info * arg_info) {
	node           *result = TBmakeFuncall(NULL, NULL, NULL);
	DBUG_ENTER("COPYfuncall");
	LUTinsertIntoLutP(INFO_LUT(arg_info), arg_node, result);
	/* Copy attributes */
	FUNCALL_NAME(result) = STRcpy(FUNCALL_NAME(arg_node));
	FUNCALL_DECL(result) = LUTsearchInLutPp(INFO_LUT(arg_info), FUNCALL_DECL(arg_node));
	FUNCALL_FUNDEF(result) = LUTsearchInLutPp(INFO_LUT(arg_info), FUNCALL_FUNDEF(arg_node));
	/* Copy sons */
...
node           *COPYfundef(node * arg_node, info * arg_info) {
	...
	FUNDEF_SYMBOLTABLE(result) = COPYTRAV(FUNDEF_SYMBOLTABLE(arg_node), arg_info);
	/* Return value */
	DBUG_RETURN(result);
}
/** <!--******************************************************************-->
 ...
 *
 ***************************************************************************/
node           *COPYglobdecl(node * arg_node, info * arg_info) {
	node           *result = TBmakeGlobdecl(T_unknown, NULL, NULL, NULL);
	DBUG_ENTER("COPYglobdecl");
	LUTinsertIntoLutP(INFO_LUT(arg_info), arg_node, result);
	/* Copy attributes */
	GLOBDECL_TYPE(result) = GLOBDECL_TYPE(arg_node);
	GLOBDECL_NAME(result) = STRcpy(GLOBDECL_NAME(arg_node));
	GLOBDECL_DECL(result) = LUTsearchInLutPp(INFO_LUT(arg_info), GLOBDECL_DECL(arg_node));
	/* Copy sons */
...
node           *COPYglobdef(node * arg_node, info * arg_info) {
	node           *result = TBmakeGlobdef(T_unknown, NULL, NULL, NULL, NULL);
	DBUG_ENTER("COPYglobdef");
	LUTinsertIntoLutP(INFO_LUT(arg_info), arg_node, result);
	/* Copy attributes */
	GLOBDEF_TYPE(result) = GLOBDEF_TYPE(arg_node);
	GLOBDEF_NAME(result) = STRcpy(GLOBDEF_NAME(arg_node));
	GLOBDEF_DECL(result) = LUTsearchInLutPp(INFO_LUT(arg_info), GLOBDEF_DECL(arg_node));
	/* Copy flags */
...
node           *COPYmonop(node * arg_node, info * arg_info) {
	...
	MONOP_TYPE(result) = MONOP_TYPE(arg_node);
	/* Copy sons */
...
node           *COPYprogram(node * arg_node, info * arg_info) {
	node           *result = TBmakeProgram(NULL, NULL, NULL, NULL, NULL);
	...
	PROGRAM_CONSTANTTABLE(result) = COPYTRAV(PROGRAM_CONSTANTTABLE(arg_node), arg_info);
	PROGRAM_EXPORTTABLE(result) = COPYTRAV(PROGRAM_EXPORTTABLE(arg_node), arg_info);
	PROGRAM_EXTERNTABLE(result) = COPYTRAV(PROGRAM_EXTERNTABLE(arg_node), arg_info);
	/* Return value */
	DBUG_RETURN(result);
}
/** <!--******************************************************************-->
...
node           *COPYreturn(node * arg_node, info * arg_info) {
	...
	LUTinsertIntoLutP(INFO_LUT(arg_info), arg_node, result);
	/* Copy attributes */
	RETURN_TYPE(result) = RETURN_TYPE(arg_node);
	/* Copy sons */
...
node           *COPYsymboltable(node * arg_node, info * arg_info) {
	node           *result = TBmakeSymboltable(NULL, NULL, NULL, NULL);
	...
	SYMBOLTABLE_PARAMS(result) = LUTsearchInLutPp(INFO_LUT(arg_info), SYMBOLTABLE_PARAMS(arg_node));
	/* Copy sons */
...
node           *COPYsymboltableentry(node * arg_node, info * arg_info) {
	node           *result = TBmakeSymboltableentry(NULL, T_unknown, 0, 0, NULL, NULL, FALSE, NULL);
	...
	SYMBOLTABLEENTRY_INDEXLEVEL(result) = SYMBOLTABLEENTRY_INDEXLEVEL(arg_node);
	SYMBOLTABLEENTRY_PARAMS(result) = LUTsearchInLutPp(INFO_LUT(arg_info), SYMBOLTABLEENTRY_PARAMS(arg_node));
	SYMBOLTABLEENTRY_FUNDEF(result) = LUTsearchInLutPp(INFO_LUT(arg_info), SYMBOLTABLEENTRY_FUNDEF(arg_node));
	SYMBOLTABLEENTRY_ISFUNCTION(result) = SYMBOLTABLEENTRY_ISFUNCTION(arg_node);
	/* Copy sons */
...
node           *COPYvardecl(node * arg_node, info * arg_info) {
	node           *result = TBmakeVardecl(T_unknown, NULL, NULL, NULL, NULL, NULL);
	DBUG_ENTER("COPYvardecl");
	LUTinsertIntoLutP(INFO_LUT(arg_info), arg_node, result);
	/* Copy attributes */
	VARDECL_TYPE(result) = VARDECL_TYPE(arg_node);
	VARDECL_NAME(result) = STRcpy(VARDECL_NAME(arg_node));
	VARDECL_DECL(result) = LUTsearchInLutPp(INFO_LUT(arg_info), VARDECL_DECL(arg_node));
	/* Copy sons */
