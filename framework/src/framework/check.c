 ...
 *
 ***************************************************************************/
node           *CHKcondexpr(node * arg_node, info * arg_info) {
	...
	if ((FALSE) || (TRUE)) {
		if (CONDEXPR_ELSE(arg_node) != NULL) {
			if (!((FALSE) || (isExpr(CONDEXPR_ELSE(arg_node))))) {
				CHKcorrectTypeInsertError(arg_node, "CONDEXPR_ELSE hasnt the right type." " It should be: " "Nodeset: Expr");
			}
		}
	} else {
		CHKnotExist(CONDEXPR_ELSE(arg_node), arg_node, "attribute CONDEXPR_ELSE must be NULL");
	}
	 ...
	 */
	if ((FALSE) || (TRUE)) {
		CHKexistSon(CONDEXPR_PRED(arg_node), arg_node, "mandatory son CONDEXPR_PRED is NULL");
		if (CONDEXPR_PRED(arg_node) != NULL) {
			if (!((FALSE) || (isExpr(CONDEXPR_PRED(arg_node))))) {
				CHKcorrectTypeInsertError(arg_node, "CONDEXPR_PRED hasnt the right type." " It should be: " "Nodeset: Expr");
			}
		}
	} else {
		CHKnotExist(CONDEXPR_PRED(arg_node), arg_node, "attribute CONDEXPR_PRED must be NULL");
	}
	...
	if ((FALSE) || (TRUE)) {
		if (CONDEXPR_THEN(arg_node) != NULL) {
			if (!((FALSE) || (isExpr(CONDEXPR_THEN(arg_node))))) {
				CHKcorrectTypeInsertError(arg_node, "CONDEXPR_THEN hasnt the right type." " It should be: " "Nodeset: Expr");
			}
		}
	} else {
		CHKnotExist(CONDEXPR_THEN(arg_node), arg_node, "attribute CONDEXPR_THEN must be NULL");
	}
 ...
 *
 ***************************************************************************/
node           *CHKconstant(node * arg_node, info * arg_info) {
	DBUG_ENTER("CHKconstant");

	/*
	 * Son check: CONSTANT_NEXT
	 */
	if ((FALSE) || (TRUE)) {
		if (CONSTANT_NEXT(arg_node) != NULL) {
			if (!((FALSE) || (NODE_TYPE(CONSTANT_NEXT(arg_node)) == N_constant))) {
				CHKcorrectTypeInsertError(arg_node, "CONSTANT_NEXT hasnt the right type." " It should be: " "N_constant");
			}
		}
	} else {
		CHKnotExist(CONSTANT_NEXT(arg_node), arg_node, "attribute CONSTANT_NEXT must be NULL");
	}

	/*
	 * Attribute check: CONSTANT_VALUE
	 */
	if ((FALSE) || (TRUE)) {
		CHKexistAttribute(CONSTANT_VALUE(arg_node), arg_node, "mandatory attribute CONSTANT_VALUE is NULL");
	} else {
		CHKnotExist(CONSTANT_VALUE(arg_node), arg_node, "attribute CONSTANT_VALUE must be NULL");
	}
	 ...
	 */
	if (CONSTANT_NEXT(arg_node) != NULL) {
		CONSTANT_NEXT(arg_node) = TRAVdo(CONSTANT_NEXT(arg_node), arg_info);
	} DBUG_RETURN(arg_node);
}
/** <!--******************************************************************-->
 *
 ...
 *
 ***************************************************************************/
node           *CHKexport(node * arg_node, info * arg_info) {
	DBUG_ENTER("CHKexport");

	/*
	 * Son check: EXPORT_NEXT
	 */
	if ((FALSE) || (TRUE)) {
		if (EXPORT_NEXT(arg_node) != NULL) {
			if (!((FALSE) || (NODE_TYPE(EXPORT_NEXT(arg_node)) == N_export))) {
				CHKcorrectTypeInsertError(arg_node, "EXPORT_NEXT hasnt the right type." " It should be: " "N_export");
			}
		}
	} else {
		CHKnotExist(EXPORT_NEXT(arg_node), arg_node, "attribute EXPORT_NEXT must be NULL");
	}

	/*
	 * Attribute check: EXPORT_FUNDEF
	 */
	if ((FALSE) || (TRUE)) {
		CHKexistAttribute(EXPORT_FUNDEF(arg_node), arg_node, "mandatory attribute EXPORT_FUNDEF is NULL");
	} else {
		CHKnotExist(EXPORT_FUNDEF(arg_node), arg_node, "attribute EXPORT_FUNDEF must be NULL");
	}
 ...
 *
 ***************************************************************************/
node           *CHKexprs(node * arg_node, info * arg_info) {
	DBUG_ENTER("CHKexprs");
	 ...
	 */
	if ((FALSE) || (TRUE)) {
		CHKexistSon(EXPRS_EXPR(arg_node), arg_node, "mandatory son EXPRS_EXPR is NULL");
		if (EXPRS_EXPR(arg_node) != NULL) {
			if (!((FALSE) || (isExpr(EXPRS_EXPR(arg_node))))) {
				CHKcorrectTypeInsertError(arg_node, "EXPRS_EXPR hasnt the right type." " It should be: " "Nodeset: Expr");
			}
		}
	} else {
		CHKnotExist(EXPRS_EXPR(arg_node), arg_node, "attribute EXPRS_EXPR must be NULL");
	}
	...
	if ((FALSE) || (TRUE)) {
		if (EXPRS_NEXT(arg_node) != NULL) {
			if (!((FALSE) || (NODE_TYPE(EXPRS_NEXT(arg_node)) == N_exprs))) {
				CHKcorrectTypeInsertError(arg_node, "EXPRS_NEXT hasnt the right type." " It should be: " "N_exprs");
			}
		}
	} else {
		CHKnotExist(EXPRS_NEXT(arg_node), arg_node, "attribute EXPRS_NEXT must be NULL");
	}
 ...
 *
 ***************************************************************************/
node           *CHKextern(node * arg_node, info * arg_info) {
	DBUG_ENTER("CHKextern");

	/*
	 * Son check: EXTERN_NEXT
	 */
	if ((FALSE) || (TRUE)) {
		if (EXTERN_NEXT(arg_node) != NULL) {
			if (!((FALSE) || (NODE_TYPE(EXTERN_NEXT(arg_node)) == N_extern))) {
				CHKcorrectTypeInsertError(arg_node, "EXTERN_NEXT hasnt the right type." " It should be: " "N_extern");
			}
		}
	} else {
		CHKnotExist(EXTERN_NEXT(arg_node), arg_node, "attribute EXTERN_NEXT must be NULL");
	}

	/*
	 * Attribute check: EXTERN_FUNDEF
	 */
	if ((FALSE) || (TRUE)) {
		CHKexistAttribute(EXTERN_FUNDEF(arg_node), arg_node, "mandatory attribute EXTERN_FUNDEF is NULL");
	} else {
		CHKnotExist(EXTERN_FUNDEF(arg_node), arg_node, "attribute EXTERN_FUNDEF must be NULL");
	}
	 ...
	 */
	if (EXTERN_NEXT(arg_node) != NULL) {
		EXTERN_NEXT(arg_node) = TRAVdo(EXTERN_NEXT(arg_node), arg_info);
	} DBUG_RETURN(arg_node);
}
/** <!--******************************************************************-->
 *
 ...
 *
 ***************************************************************************/
node           *CHKfuncall(node * arg_node, info * arg_info) {
	...
	if ((FALSE) || (TRUE)) {
		if (FUNCALL_ARGS(arg_node) != NULL) {
			if (!((FALSE) || (NODE_TYPE(FUNCALL_ARGS(arg_node)) == N_exprs))) {
				CHKcorrectTypeInsertError(arg_node, "FUNCALL_ARGS hasnt the right type." " It should be: " "N_exprs");
			}
		}
	} else {
		CHKnotExist(FUNCALL_ARGS(arg_node), arg_node, "attribute FUNCALL_ARGS must be NULL");
	}
	 ...
	 */
	if ((FALSE) || (TRUE)) {
		CHKexistAttribute(FUNCALL_DECL(arg_node), arg_node, "mandatory attribute FUNCALL_DECL is NULL");
	} else {
		CHKnotExist(FUNCALL_DECL(arg_node), arg_node, "attribute FUNCALL_DECL must be NULL");
	}

	/*
	 * Attribute check: FUNCALL_FUNDEF
	 */
	if ((FALSE) || (TRUE)) {
	} else {
		CHKnotExist(FUNCALL_FUNDEF(arg_node), arg_node, "attribute FUNCALL_FUNDEF must be NULL");
	}
	 ...
	 */
	if ((FALSE) || (TRUE)) {
		CHKexistAttribute(FUNCALL_NAME(arg_node), arg_node, "mandatory attribute FUNCALL_NAME is NULL");
	} else {
		CHKnotExist(FUNCALL_NAME(arg_node), arg_node, "attribute FUNCALL_NAME must be NULL");
	}
...
node           *CHKfundef(node * arg_node, info * arg_info) {
	...
	if ((FALSE) || (TRUE)) {
		if (FUNDEF_SYMBOLTABLE(arg_node) != NULL) {
			if (!((FALSE) || (NODE_TYPE(FUNDEF_SYMBOLTABLE(arg_node)) == N_symboltable))) {
				CHKcorrectTypeInsertError(arg_node, "FUNDEF_SYMBOLTABLE hasnt the right type." " It should be: " "N_symboltable");
			}
		}
	} else {
		CHKnotExist(FUNDEF_SYMBOLTABLE(arg_node), arg_node, "attribute FUNDEF_SYMBOLTABLE must be NULL");
	}
	 ...
	 */
	if ((FALSE) || (TRUE)) {
		CHKexistAttribute(FUNDEF_NAME(arg_node), arg_node, "mandatory attribute FUNDEF_NAME is NULL");
	} else {
		CHKnotExist(FUNDEF_NAME(arg_node), arg_node, "attribute FUNDEF_NAME must be NULL");
	}
 ...
 *
 ***************************************************************************/
node           *CHKglobdecl(node * arg_node, info * arg_info) {
	...
	if ((FALSE) || (TRUE)) {
		if (GLOBDECL_DIMS(arg_node) != NULL) {
			if (!((FALSE) || (NODE_TYPE(GLOBDECL_DIMS(arg_node)) == N_ids))) {
				CHKcorrectTypeInsertError(arg_node, "GLOBDECL_DIMS hasnt the right type." " It should be: " "N_ids");
			}
		}
	} else {
		CHKnotExist(GLOBDECL_DIMS(arg_node), arg_node, "attribute GLOBDECL_DIMS must be NULL");
	}

	/*
	 * Attribute check: GLOBDECL_DECL
	 */
	if ((FALSE) || (TRUE)) {
		CHKexistAttribute(GLOBDECL_DECL(arg_node), arg_node, "mandatory attribute GLOBDECL_DECL is NULL");
	} else {
		CHKnotExist(GLOBDECL_DECL(arg_node), arg_node, "attribute GLOBDECL_DECL must be NULL");
	}
	 ...
	 */
	if ((FALSE) || (TRUE)) {
		CHKexistAttribute(GLOBDECL_NAME(arg_node), arg_node, "mandatory attribute GLOBDECL_NAME is NULL");
	} else {
		CHKnotExist(GLOBDECL_NAME(arg_node), arg_node, "attribute GLOBDECL_NAME must be NULL");
	}
	...
	if ((FALSE) || (TRUE)) {
		if (GLOBDEF_DIMS(arg_node) != NULL) {
			if (!((FALSE) || (NODE_TYPE(GLOBDEF_DIMS(arg_node)) == N_exprs))) {
				CHKcorrectTypeInsertError(arg_node, "GLOBDEF_DIMS hasnt the right type." " It should be: " "N_exprs");
			}
		}
	} else {
		CHKnotExist(GLOBDEF_DIMS(arg_node), arg_node, "attribute GLOBDEF_DIMS must be NULL");
	}
	...
	if ((FALSE) || (TRUE)) {
		if (GLOBDEF_INIT(arg_node) != NULL) {
			if (!((FALSE) || (isExpr(GLOBDEF_INIT(arg_node))))) {
				CHKcorrectTypeInsertError(arg_node, "GLOBDEF_INIT hasnt the right type." " It should be: " "Nodeset: Expr");
			}
		}
	} else {
		CHKnotExist(GLOBDEF_INIT(arg_node), arg_node, "attribute GLOBDEF_INIT must be NULL");
	}

	/*
	 * Attribute check: GLOBDEF_DECL
	 */
	if ((FALSE) || (TRUE)) {
		CHKexistAttribute(GLOBDEF_DECL(arg_node), arg_node, "mandatory attribute GLOBDEF_DECL is NULL");
	} else {
		CHKnotExist(GLOBDEF_DECL(arg_node), arg_node, "attribute GLOBDEF_DECL must be NULL");
	}
...
node           *CHKids(node * arg_node, info * arg_info) {
	...
	if ((FALSE) || (TRUE)) {
		if (IDS_NEXT(arg_node) != NULL) {
			if (!((FALSE) || (NODE_TYPE(IDS_NEXT(arg_node)) == N_ids))) {
				CHKcorrectTypeInsertError(arg_node, "IDS_NEXT hasnt the right type." " It should be: " "N_ids");
			}
		}
	} else {
		CHKnotExist(IDS_NEXT(arg_node), arg_node, "attribute IDS_NEXT must be NULL");
	}
	 ...
	 */
	if ((FALSE) || (TRUE)) {
		CHKexistAttribute(IDS_NAME(arg_node), arg_node, "mandatory attribute IDS_NAME is NULL");
	} else {
		CHKnotExist(IDS_NAME(arg_node), arg_node, "attribute IDS_NAME must be NULL");
	}
	...
	if ((FALSE) || (TRUE)) {
		if (PARAM_DIMS(arg_node) != NULL) {
			if (!((FALSE) || (NODE_TYPE(PARAM_DIMS(arg_node)) == N_ids))) {
				CHKcorrectTypeInsertError(arg_node, "PARAM_DIMS hasnt the right type." " It should be: " "N_ids");
			}
		}
	} else {
		CHKnotExist(PARAM_DIMS(arg_node), arg_node, "attribute PARAM_DIMS must be NULL");
	}
...
node           *CHKprogram(node * arg_node, info * arg_info) {
	...
	/*
	 * Son check: PROGRAM_CONSTANTTABLE
	 */
	if ((FALSE) || (TRUE)) {
		if (PROGRAM_CONSTANTTABLE(arg_node) != NULL) {
			if (!((FALSE) || (NODE_TYPE(PROGRAM_CONSTANTTABLE(arg_node)) == N_constant))) {
				CHKcorrectTypeInsertError(arg_node, "PROGRAM_CONSTANTTABLE hasnt the right type." " It should be: " "N_constant");
			}
		}
	} else {
		CHKnotExist(PROGRAM_CONSTANTTABLE(arg_node), arg_node, "attribute PROGRAM_CONSTANTTABLE must be NULL");
	}
	...
	/*
	 * Son check: PROGRAM_EXPORTTABLE
	 */
	if ((FALSE) || (TRUE)) {
		if (PROGRAM_EXPORTTABLE(arg_node) != NULL) {
			if (!((FALSE) || (NODE_TYPE(PROGRAM_EXPORTTABLE(arg_node)) == N_export))) {
				CHKcorrectTypeInsertError(arg_node, "PROGRAM_EXPORTTABLE hasnt the right type." " It should be: " "N_export");
			}
		}
	} else {
		CHKnotExist(PROGRAM_EXPORTTABLE(arg_node), arg_node, "attribute PROGRAM_EXPORTTABLE must be NULL");
	}

	/*
	 * Son check: PROGRAM_EXTERNTABLE
	 */
	if ((FALSE) || (TRUE)) {
		if (PROGRAM_EXTERNTABLE(arg_node) != NULL) {
			if (!((FALSE) || (NODE_TYPE(PROGRAM_EXTERNTABLE(arg_node)) == N_extern))) {
				CHKcorrectTypeInsertError(arg_node, "PROGRAM_EXTERNTABLE hasnt the right type." " It should be: " "N_extern");
			}
		}
	} else {
		CHKnotExist(PROGRAM_EXTERNTABLE(arg_node), arg_node, "attribute PROGRAM_EXTERNTABLE must be NULL");
	}
	 ...
	 */
	if (PROGRAM_CONSTANTTABLE(arg_node) != NULL) {
		PROGRAM_CONSTANTTABLE(arg_node) = TRAVdo(PROGRAM_CONSTANTTABLE(arg_node), arg_info);
	}
	/*
	 * trav functions: to get all sons
	 */
	 ...
	 */
	if (PROGRAM_EXPORTTABLE(arg_node) != NULL) {
		PROGRAM_EXPORTTABLE(arg_node) = TRAVdo(PROGRAM_EXPORTTABLE(arg_node), arg_info);
	}
	/*
	 * trav functions: to get all sons
	 */
	if (PROGRAM_EXTERNTABLE(arg_node) != NULL) {
		PROGRAM_EXTERNTABLE(arg_node) = TRAVdo(PROGRAM_EXTERNTABLE(arg_node), arg_info);
	}
	/*
	 * trav functions: to get all sons
	 */
...
node           *CHKsymboltable(node * arg_node, info * arg_info) {
	...
	/*
	 * Attribute check: SYMBOLTABLE_PARAMS
	 */
	if ((FALSE) || (TRUE)) {
		CHKexistAttribute(SYMBOLTABLE_PARAMS(arg_node), arg_node, "mandatory attribute SYMBOLTABLE_PARAMS is NULL");
	} else {
		CHKnotExist(SYMBOLTABLE_PARAMS(arg_node), arg_node, "attribute SYMBOLTABLE_PARAMS must be NULL");
	}
	 ...
	 */
	if ((FALSE) || (TRUE)) {
		CHKexistAttribute(SYMBOLTABLE_PARENT(arg_node), arg_node, "mandatory attribute SYMBOLTABLE_PARENT is NULL");
	} else {
...
node           *CHKsymboltableentry(node * arg_node, info * arg_info) {
	...
	/*
	 * Attribute check: SYMBOLTABLEENTRY_FUNDEF
	 */
	if ((FALSE) || (TRUE)) {
		CHKexistAttribute(SYMBOLTABLEENTRY_FUNDEF(arg_node), arg_node, "mandatory attribute SYMBOLTABLEENTRY_FUNDEF is NULL");
	} else {
		CHKnotExist(SYMBOLTABLEENTRY_FUNDEF(arg_node), arg_node, "attribute SYMBOLTABLEENTRY_FUNDEF must be NULL");
	}
	 ...
	 */
	if ((FALSE) || (TRUE)) {
		CHKexistAttribute(SYMBOLTABLEENTRY_PARAMS(arg_node), arg_node, "mandatory attribute SYMBOLTABLEENTRY_PARAMS is NULL");
	} else {
		CHKnotExist(SYMBOLTABLEENTRY_PARAMS(arg_node), arg_node, "attribute SYMBOLTABLEENTRY_PARAMS must be NULL");
	}
...
node           *CHKvar(node * arg_node, info * arg_info) {
	...
	if ((FALSE) || (TRUE)) {
		if (VAR_INDICES(arg_node) != NULL) {
			if (!((FALSE) || (NODE_TYPE(VAR_INDICES(arg_node)) == N_exprs))) {
				CHKcorrectTypeInsertError(arg_node, "VAR_INDICES hasnt the right type." " It should be: " "N_exprs");
			}
		}
	} else {
		CHKnotExist(VAR_INDICES(arg_node), arg_node, "attribute VAR_INDICES must be NULL");
	}
	 ...
	 */
	if ((FALSE) || (TRUE)) {
		CHKexistAttribute(VAR_DECL(arg_node), arg_node, "mandatory attribute VAR_DECL is NULL");
	} else {
...
node           *CHKvardecl(node * arg_node, info * arg_info) {
	...
	if ((FALSE) || (TRUE)) {
		if (VARDECL_DIMS(arg_node) != NULL) {
			if (!((FALSE) || (NODE_TYPE(VARDECL_DIMS(arg_node)) == N_exprs))) {
				CHKcorrectTypeInsertError(arg_node, "VARDECL_DIMS hasnt the right type." " It should be: " "N_exprs");
			}
		}
	} else {
		CHKnotExist(VARDECL_DIMS(arg_node), arg_node, "attribute VARDECL_DIMS must be NULL");
	}
	...
	if ((FALSE) || (TRUE)) {
		if (VARDECL_INIT(arg_node) != NULL) {
			if (!((FALSE) || (isExpr(VARDECL_INIT(arg_node))))) {
				CHKcorrectTypeInsertError(arg_node, "VARDECL_INIT hasnt the right type." " It should be: " "Nodeset: Expr");
			}
		}
	} else {
		CHKnotExist(VARDECL_INIT(arg_node), arg_node, "attribute VARDECL_INIT must be NULL");
	}
	...
	if ((FALSE) || (TRUE)) {
		if (VARDECL_NEXT(arg_node) != NULL) {
			if (!((FALSE) || (NODE_TYPE(VARDECL_NEXT(arg_node)) == N_vardecl))) {
				CHKcorrectTypeInsertError(arg_node, "VARDECL_NEXT hasnt the right type." " It should be: " "N_vardecl");
			}
		}
	} else {
	...
	/*
	 * Attribute check: VARDECL_DECL
	 */
	if ((FALSE) || (TRUE)) {
		CHKexistAttribute(VARDECL_DECL(arg_node), arg_node, "mandatory attribute VARDECL_DECL is NULL");
	} else {
		CHKnotExist(VARDECL_DECL(arg_node), arg_node, "attribute VARDECL_DECL must be NULL");
	}
...
node           *CHKvarlet(node * arg_node, info * arg_info) {
	...
	if ((FALSE) || (TRUE)) {
		if (VARLET_INDICES(arg_node) != NULL) {
			if (!((FALSE) || (NODE_TYPE(VARLET_INDICES(arg_node)) == N_exprs))) {
				CHKcorrectTypeInsertError(arg_node, "VARLET_INDICES hasnt the right type." " It should be: " "N_exprs");
			}
		}
	} else {
		CHKnotExist(VARLET_INDICES(arg_node), arg_node, "attribute VARLET_INDICES must be NULL");
	}
	 ...
	 */
	if ((FALSE) || (TRUE)) {
		CHKexistAttribute(VARLET_DECL(arg_node), arg_node, "mandatory attribute VARLET_DECL is NULL");
	} else {
...
typedef enum {
	...
	CHK_constant_type,
	CHK_error_message,
	CHK_export_indexlevel,
	CHK_extern_indexlevel,
	CHK_float_value,
	CHK_for_loopvar,
	CHK_funcall_name,
	CHK_fundef_type,
