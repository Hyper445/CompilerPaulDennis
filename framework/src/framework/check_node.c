 ...
 *
 ***************************************************************************/
node           *CHKMcondexpr(node * arg_node, info * arg_info) {
 ...
 *
 ***************************************************************************/
node           *CHKMconstant(node * arg_node, info * arg_info) {
	DBUG_ENTER("CHKMconstant");
	NODE_ERROR(arg_node) = CHKMTRAV(NODE_ERROR(arg_node), arg_info);
	CONSTANT_NEXT(arg_node) = CHKMTRAV(CONSTANT_NEXT(arg_node), arg_info);
	CONSTANT_VALUE(arg_node) = CHKMattribLink(CONSTANT_VALUE(arg_node), arg_info);
	DBUG_RETURN(arg_node);
}
/** <!--******************************************************************-->
 *
 ...
 *
 ***************************************************************************/
node           *CHKMexport(node * arg_node, info * arg_info) {
	DBUG_ENTER("CHKMexport");
	NODE_ERROR(arg_node) = CHKMTRAV(NODE_ERROR(arg_node), arg_info);
	EXPORT_NEXT(arg_node) = CHKMTRAV(EXPORT_NEXT(arg_node), arg_info);
	EXPORT_FUNDEF(arg_node) = CHKMattribLink(EXPORT_FUNDEF(arg_node), arg_info);
	DBUG_RETURN(arg_node);
}
/** <!--******************************************************************-->
 *
 ...
 *
 ***************************************************************************/
node           *CHKMextern(node * arg_node, info * arg_info) {
	DBUG_ENTER("CHKMextern");
	NODE_ERROR(arg_node) = CHKMTRAV(NODE_ERROR(arg_node), arg_info);
	EXTERN_NEXT(arg_node) = CHKMTRAV(EXTERN_NEXT(arg_node), arg_info);
	EXTERN_FUNDEF(arg_node) = CHKMattribLink(EXTERN_FUNDEF(arg_node), arg_info);
	DBUG_RETURN(arg_node);
}
/** <!--******************************************************************-->
 *
...
node           *CHKMfuncall(node * arg_node, info * arg_info) {
	...
	FUNCALL_FUNDEF(arg_node) = CHKMattribLink(FUNCALL_FUNDEF(arg_node), arg_info);
...
node           *CHKMfundef(node * arg_node, info * arg_info) {
	...
	FUNDEF_SYMBOLTABLE(arg_node) = CHKMTRAV(FUNDEF_SYMBOLTABLE(arg_node), arg_info);
	DBUG_RETURN(arg_node);
}
/** <!--******************************************************************-->
 *
...
node           *CHKMglobdecl(node * arg_node, info * arg_info) {
	...
	GLOBDECL_DECL(arg_node) = CHKMattribLink(GLOBDECL_DECL(arg_node), arg_info);
...
node           *CHKMglobdef(node * arg_node, info * arg_info) {
	...
	GLOBDEF_DECL(arg_node) = CHKMattribLink(GLOBDEF_DECL(arg_node), arg_info);
...
node           *CHKMprogram(node * arg_node, info * arg_info) {
	...
	PROGRAM_SYMBOLTABLE(arg_node) = CHKMTRAV(PROGRAM_SYMBOLTABLE(arg_node), arg_info);
	PROGRAM_CONSTANTTABLE(arg_node) = CHKMTRAV(PROGRAM_CONSTANTTABLE(arg_node), arg_info);
	PROGRAM_EXPORTTABLE(arg_node) = CHKMTRAV(PROGRAM_EXPORTTABLE(arg_node), arg_info);
	PROGRAM_EXTERNTABLE(arg_node) = CHKMTRAV(PROGRAM_EXTERNTABLE(arg_node), arg_info);
	DBUG_RETURN(arg_node);
}
/** <!--******************************************************************-->
 *
...
node           *CHKMsymboltable(node * arg_node, info * arg_info) {
	...
	SYMBOLTABLE_PARENT(arg_node) = CHKMattribLink(SYMBOLTABLE_PARENT(arg_node), arg_info);
	SYMBOLTABLE_PARAMS(arg_node) = CHKMattribLink(SYMBOLTABLE_PARAMS(arg_node), arg_info);
...
node           *CHKMsymboltableentry(node * arg_node, info * arg_info) {
	...
	NODE_ERROR(arg_node) = CHKMTRAV(NODE_ERROR(arg_node), arg_info);
	SYMBOLTABLEENTRY_NEXT(arg_node) = CHKMTRAV(SYMBOLTABLEENTRY_NEXT(arg_node), arg_info);
	SYMBOLTABLEENTRY_NAME(arg_node) = CHKMattribString(SYMBOLTABLEENTRY_NAME(arg_node), arg_info);
	SYMBOLTABLEENTRY_PARAMS(arg_node) = CHKMattribLink(SYMBOLTABLEENTRY_PARAMS(arg_node), arg_info);
	SYMBOLTABLEENTRY_FUNDEF(arg_node) = CHKMattribLink(SYMBOLTABLEENTRY_FUNDEF(arg_node), arg_info);
	DBUG_RETURN(arg_node);
}
/** <!--******************************************************************-->
 *
...
node           *CHKMvardecl(node * arg_node, info * arg_info) {
	...
	VARDECL_DECL(arg_node) = CHKMattribLink(VARDECL_DECL(arg_node), arg_info);
