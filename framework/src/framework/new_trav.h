...
extern node    *EVALconstant(node * arg_node, info * arg_info);
extern node    *EVALdecls(node * arg_node, info * arg_info);
...
extern node    *EVALglobdecl(node * arg_node, info * arg_info);
extern node    *EVALglobdef(node * arg_node, info * arg_info);
