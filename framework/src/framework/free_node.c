 ...
 *
 ***************************************************************************/
node           *FREEcondexpr(node * arg_node, info * arg_info) {
	node           *result = NULL;
 ...
 *
 ***************************************************************************/
node           *FREEconstant(node * arg_node, info * arg_info) {
	node           *result = NULL;
	DBUG_ENTER("FREEconstant");
	DBUG_PRINT("FREE", ("Processing node N_constant at " F_PTR, arg_node));
	CONSTANT_NEXT(arg_node) = FREECOND(CONSTANT_NEXT(arg_node), arg_info);
	CONSTANT_VALUE(arg_node) = FREEattribLink(CONSTANT_VALUE(arg_node), arg_node);
	result = CONSTANT_NEXT(arg_node);
	arg_node->sons.N_constant = MEMfree(arg_node->sons.N_constant);
	arg_node->attribs.N_constant = MEMfree(arg_node->attribs.N_constant);
	DBUG_PRINT("FREE", ("Processing node N_constant at " F_PTR, arg_node));
 ...
 *
 ***************************************************************************/
node           *FREEexport(node * arg_node, info * arg_info) {
	node           *result = NULL;
	DBUG_ENTER("FREEexport");
	DBUG_PRINT("FREE", ("Processing node N_export at " F_PTR, arg_node));
	EXPORT_NEXT(arg_node) = FREECOND(EXPORT_NEXT(arg_node), arg_info);
	EXPORT_FUNDEF(arg_node) = FREEattribLink(EXPORT_FUNDEF(arg_node), arg_node);
	result = EXPORT_NEXT(arg_node);
 ...
 *
 ***************************************************************************/
node           *FREEextern(node * arg_node, info * arg_info) {
	node           *result = NULL;
	DBUG_ENTER("FREEextern");
	DBUG_PRINT("FREE", ("Processing node N_extern at " F_PTR, arg_node));
	EXTERN_NEXT(arg_node) = FREECOND(EXTERN_NEXT(arg_node), arg_info);
	EXTERN_FUNDEF(arg_node) = FREEattribLink(EXTERN_FUNDEF(arg_node), arg_node);
	result = EXTERN_NEXT(arg_node);
...
node           *FREEfuncall(node * arg_node, info * arg_info) {
	...
	FUNCALL_FUNDEF(arg_node) = FREEattribLink(FUNCALL_FUNDEF(arg_node), arg_node);
...
node           *FREEfundef(node * arg_node, info * arg_info) {
	...
	FUNDEF_SYMBOLTABLE(arg_node) = FREETRAV(FUNDEF_SYMBOLTABLE(arg_node), arg_info);
	result = NULL;
...
node           *FREEglobdecl(node * arg_node, info * arg_info) {
	...
	GLOBDECL_DECL(arg_node) = FREEattribLink(GLOBDECL_DECL(arg_node), arg_node);
...
node           *FREEglobdef(node * arg_node, info * arg_info) {
	...
	GLOBDEF_DECL(arg_node) = FREEattribLink(GLOBDEF_DECL(arg_node), arg_node);
...
node           *FREEprogram(node * arg_node, info * arg_info) {
	...
	PROGRAM_CONSTANTTABLE(arg_node) = FREETRAV(PROGRAM_CONSTANTTABLE(arg_node), arg_info);
	PROGRAM_EXPORTTABLE(arg_node) = FREETRAV(PROGRAM_EXPORTTABLE(arg_node), arg_info);
	PROGRAM_EXTERNTABLE(arg_node) = FREETRAV(PROGRAM_EXTERNTABLE(arg_node), arg_info);
	result = NULL;
...
node           *FREEsymboltable(node * arg_node, info * arg_info) {
	...
	SYMBOLTABLE_PARAMS(arg_node) = FREEattribLink(SYMBOLTABLE_PARAMS(arg_node), arg_node);
...
node           *FREEsymboltableentry(node * arg_node, info * arg_info) {
	...
	SYMBOLTABLEENTRY_PARAMS(arg_node) = FREEattribLink(SYMBOLTABLEENTRY_PARAMS(arg_node), arg_node);
	SYMBOLTABLEENTRY_FUNDEF(arg_node) = FREEattribLink(SYMBOLTABLEENTRY_FUNDEF(arg_node), arg_node);
...
node           *FREEvardecl(node * arg_node, info * arg_info) {
	...
	VARDECL_DECL(arg_node) = FREEattribLink(VARDECL_DECL(arg_node), arg_node);
